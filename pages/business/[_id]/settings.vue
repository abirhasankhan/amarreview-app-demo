    ...
    <div class="space-y-6">
      ...
      <div class="bg-white rounded-lg shadow-sm p-6">
        ...
        <div class="flex items-center justify-between">
          ...
          <NuxtLink to="/business/premium" v-if="subscription.plan === 'Free'"
            class="px-4 py-2 bg-emerald-600 text-white rounded-md hover:bg-emerald-700">
            Upgrade to Premium
          </NuxtLink>
          <button v-else @click="cancelSubscription"
      ...
      <div class="bg-white rounded-lg shadow-sm p-6">
        ...
        <div class="space-y-4">
          <label class="flex items-center">
            <input v-model="notifications.newReviews" type="checkbox"
              class="h-4 w-4 text-emerald-600 focus:ring-emerald-500 border-gray-300 rounded" />
            <span class="ml-2">Email notifications for new reviews</span>
          </label>
          <label class="flex items-center">
            <input v-model="notifications.messages" type="checkbox"
              class="h-4 w-4 text-emerald-600 focus:ring-emerald-500 border-gray-300 rounded" />
      ...
      <div class="bg-white rounded-lg shadow-sm p-6">
        ...
        <div class="space-y-4">
          <button @click="deactivateAccount" class="text-red-600 hover:text-red-700">
            Deactivate Account
          </button>
        </div>
      </div>
