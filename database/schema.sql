...
-- Step 1: Create a function to handle the insert into profiles
...
begin
  ...
  base_username := lower(regexp_replace(new.raw_user_meta_data ->> 'full_name', '\s+', '_', 'g'));
...
-- Step 2: Create a trigger on auth.users to run this function after user signup
