  ...
  <div>
    ...
    <div v-if="status === 'unverified'" class="space-y-4">
      <p class="text-gray-600">
        Verify your business to get a "Verified Business" badge and build trust with customers.
      </p>
    ...
    <div v-else class="bg-green-50 p-4 rounded-md">
      <div class="flex items-center">
        ...
        <p class="text-green-800">
          Your business is verified! The verification badge is now displayed on your profile.
        </p>
      </div>
    </div>
  </div>
